...
?> - Xoogle</title>
    ...
    <body>
        <form class="sub-search-container" method="get" autocomplete="off">
            <h1 class="logomobile"><a class="no-decoration" href="./"><span class="X">X</span></a>oogle</h1>
            ...
            <div class="sub-search-button-wrapper">
                <button name="t" value="0"><img src="static/images/general_result.png" alt="text result" />Weby</button>
                <button name="t" value="1"><img src="static/images/images_result.png" alt="image result" />Obrázky</button>
                <button name="t" value="2"><img src="static/images/videos_result.png" alt="video result" />Videa</button>
                <button name="t" value="3"><img src="static/images/torrents_result.png" alt="torrent result" />Torrenty</button>
                <button name="t" value="4"><img src="static/images/tor_result.png" alt="tor result" />Tor/Onion</button>
            </div>
        <hr>
        </form>
